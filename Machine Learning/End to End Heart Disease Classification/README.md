...
Plz, make sure that before opening `end-to-end-heart-disease-classification` notebook your anaconda enviornment is configured and all the required packages are installed.
